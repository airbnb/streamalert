...
def test_as_custom_details_ignores_custom_fields():
    ...
    expectation = {
        'publishers': {'pagerduty': ['stream_alert.shared.publisher.DefaultPublisher', 'publishers.community.pagerduty.pagerduty_layout.ShortenTitle', 'publishers.community.pagerduty.pagerduty_layout.as_custom_details']},
        'source_entity': 'corp-prefix.prod.cb.region',
        'created': '2019-01-01T00:00:00.000000Z', 'outputs': ['slack:unit_test_channel'],


        '@pagerduty.details': {
            'publishers': {'pagerduty': ['stream_alert.shared.publisher.DefaultPublisher', 'publishers.community.pagerduty.pagerduty_layout.ShortenTitle', 'publishers.community.pagerduty.pagerduty_layout.as_custom_details']},
            'source_entity': 'corp-prefix.prod.cb.region', 'created': '2019-01-01T00:00:00.000000Z', 'outputs': ['slack:unit_test_channel'], 'log_source': 'carbonblack:binarystore.file.added', 'staged': False, 'id': '79192344-4a6d-4850-8d06-9c3fef1060a4', 'cluster': '', 'rule_description': 'Info about this rule and what actions to take', 'context': {'context': 'value'}, 'source_service': 's3', 'record': {'compressed_size': '9982', 'timestamp': '1496947381.18', 'node_id': '1', 'cb_server': 'cbserver', 'md5': '0F9AA55DA3BDE84B35656AD8911A22E1', 'type': 'binarystore.file.added', 'file_path': '/tmp/5DA/AD8/0F9AA55DA3BDE84B35656AD8911A22E1.zip', 'size': '21504'}, 'log_type': 'json', 'rule_name': 'cb_binarystore_file_added'}, 'staged': False, '@pagerduty-v2.summary': 'cb_binarystore_file_added', 'log_type': 'json', 'cluster': '', 'rule_name': 'cb_binarystore_file_added', '@pagerduty-incident.incident_title': 'cb_binarystore_file_added', '@pagerduty.description': 'cb_binarystore_file_added', '@pagerduty-v2.custom_details': {'publishers': {'pagerduty': ['stream_alert.shared.publisher.DefaultPublisher', 'publishers.community.pagerduty.pagerduty_layout.ShortenTitle', 'publishers.community.pagerduty.pagerduty_layout.as_custom_details']}, 'source_entity': 'corp-prefix.prod.cb.region', 'created': '2019-01-01T00:00:00.000000Z', 'outputs': ['slack:unit_test_channel'], 'log_source': 'carbonblack:binarystore.file.added', 'staged': False, 'id': '79192344-4a6d-4850-8d06-9c3fef1060a4', 'cluster': '', 'rule_description': 'Info about this rule and what actions to take', 'context': {'context': 'value'}, 'source_service': 's3', 'record': {'compressed_size': '9982', 'timestamp': '1496947381.18', 'node_id': '1', 'cb_server': 'cbserver', 'md5': '0F9AA55DA3BDE84B35656AD8911A22E1', 'type': 'binarystore.file.added', 'file_path': '/tmp/5DA/AD8/0F9AA55DA3BDE84B35656AD8911A22E1.zip', 'size': '21504'}, 'log_type': 'json', 'rule_name': 'cb_binarystore_file_added'}, 'context': {'context': 'value'}, 'source_service': 's3', 'id': '79192344-4a6d-4850-8d06-9c3fef1060a4', 'record': {'compressed_size': '9982', 'timestamp': '1496947381.18', 'node_id': '1', 'cb_server': 'cbserver', 'md5': '0F9AA55DA3BDE84B35656AD8911A22E1', 'type': 'binarystore.file.added', 'file_path': '/tmp/5DA/AD8/0F9AA55DA3BDE84B35656AD8911A22E1.zip', 'size': '21504'}, 'log_source': 'carbonblack:binarystore.file.added', 'rule_description': 'Info about this rule and what actions to take'}
