...
resource "aws_lambda_event_source_mapping" "stream_alert_kinesis_staging_event_mapping" {
  enabled           = "${var.lambda_staging_enabled}"
  batch_size        = 100
  event_source_arn  = "${var.kinesis_stream_arn}"
  function_name     = "${var.lambda_function_arn}:staging"
