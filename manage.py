...
class CreateClusterAlarmCommand(object):
...
class MetricAlarmCommand(object):
...
class LookupTablesCommand(object):
...
def build_parser():
    ...
    commands = {
        ...
        'create-cluster-alarm': (
            CreateClusterAlarmCommand.setup_subparser,
        ...
        'destroy': (
            DestroyCommand.setup_subparser,
