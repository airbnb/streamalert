...
from stream_alert_cli.utils import CliCommand, set_parser_epilog, add_default_tf_args
...
class TerraformCleanCommand(CliCommand):
    ...
    @classmethod
    def setup_subparser(cls, subparser):
        """Terraform Clean takes no arguments"""
...
class TerraformListTargetsCommand(CliCommand):
    ...
    @classmethod
    def setup_subparser(cls, subparser):
        """list-targets accepts no arguments"""
